...
echo "  /primer            - Analyze codebase (run first)"
...
echo "  1. /primer          - Understand codebase"
echo "  2. /project-plan    - Create PRP for feature"
echo "  3. /project-tdd     - Implement with tests first"
echo "  4. /project-validate - Verify quality gates"
